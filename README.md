...
> By default an unstable `develop` branch in front of the project. If you want to use wrapper in prodaction see stable `master` branch or download it from [Releases](https://github.com/nikvoronin/XInput.Wrapper/releases) or use `nuget` packets.
